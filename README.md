...
## 关于本仓库（Pride-lee / [lx-music-mobile](https://github.com/app-pop/lxmusic)）
...
- `.github/workflows/release.yml`：`push master` 或手动 `workflow_dispatch` 时构建多架构 APK 并发到 [Releases](https://github.com/app-pop/lxmusic/releases)。
